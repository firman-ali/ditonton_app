...
void main() {
  ...
  group('Airing Today Tv Show', () {
    ...
    test('should return CommonFailure when link with invalid ssl certificate',
        () async {
      // arrange
      when(mockRemoteDataSource.getAiringTodayTv())
    ...
    test('should return CommonFailure when application has error', () async {
      // arrange
      when(mockRemoteDataSource.getAiringTodayTv()).thenThrow('Error');
      // act
      final result = await repository.getAiringTodayTv();
      // assert
      expect(result, const Left(CommonFailure('Error')));
    });
  });
  ...
  group('On The Air Tv Show', () {
    ...
    test('should return CommonFailure when application has error', () async {
      // arrange
      when(mockRemoteDataSource.getOnAirTv()).thenThrow('Error');
      // act
      final result = await repository.getOnAirTv();
      // assert
      expect(result, const Left(CommonFailure('Error')));
  ...
  group('Popular tv show', () {
    ...
    test('should return CommonFailure when application has error', () async {
      // arrange
      when(mockRemoteDataSource.getPopularTv()).thenThrow('Error');
      // act
      final result = await repository.getPopularTv();
      // assert
      expect(result, const Left(CommonFailure('Error')));
  ...
  group('Top rated tv show', () {
    ...
    test('should return CommonFailure when application has error', () async {
      // arrange
      when(mockRemoteDataSource.getTopRatedTv()).thenThrow('Error');
      // act
      final result = await repository.getTopRatedTv();
      // assert
      expect(result, const Left(CommonFailure('Error')));
  ...
  group('Get tv show detail', () {
    ...
    test('should return CommonFailure when application has error', () async {
      // arrange
      when(mockRemoteDataSource.getTvDetail(tId)).thenThrow('Error');
      // act
      final result = await repository.getTvDetail(tId);
      // assert
      expect(result, const Left(CommonFailure('Error')));
  ...
  group('Get tv show recommendations', () {
    ...
    test('should return CommonFailure when application has error', () async {
      // arrange
      when(mockRemoteDataSource.getTvRecommendations(tId)).thenThrow('Error');
      // act
      final result = await repository.getTvRecommendations(tId);
      // assert
      expect(result, const Left(CommonFailure('Error')));
  ...
  group('Seach tv show', () {
    ...
    test('should return CommonFailure when application has error', () async {
      // arrange
      when(mockRemoteDataSource.searchTv(tQuery)).thenThrow('Error');
      // act
      final result = await repository.searchTv(tQuery);
      // assert
      expect(result, const Left(CommonFailure('Error')));
