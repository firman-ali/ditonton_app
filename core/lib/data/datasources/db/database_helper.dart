...
class DatabaseHelper {
  ...
  static const String _tblWatchlistMv = 'watchlistMovie';
  ...
  Future<int> insertWatchlist(MovieTable movie) async {
    ...
    return await db!.insert(_tblWatchlistMv, movie.toJson());
  }
  ...
  Future<List<Map<String, dynamic>>> getWatchlistMovies() async {
    final db = await database;
    final List<Map<String, dynamic>> results = await db!.query(_tblWatchlistMv);
