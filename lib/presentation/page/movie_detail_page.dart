  ...
  void initState() {
    ...
    Future.microtask(() {
      ...
      context
          ...
          .add(GetWatchlistStatusMovie(widget.id));
    });
  }
...
class DetailContent extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    return BlocListener<WatchlistStatusMovieBloc, WatchlistStatusMovieState>(
      listener: (context, state) {
        if (state is AddWatchlistMovieSuccess) {
          final message = state.message;
          ScaffoldMessenger.of(context)
              .showSnackBar(SnackBar(content: Text(message)));
        } else if (state is RemoveWatchlistMovieSuccess) {
          final message = state.message;
          ScaffoldMessenger.of(context)
              .showSnackBar(SnackBar(content: Text(message)));
        }
                        ...
                        child: SingleChildScrollView(
                          ...
                          child: Column(
                            ...
                            children: [
                              ...
                              BlocBuilder<WatchlistStatusMovieBloc,
